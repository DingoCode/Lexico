    ...
    public partial class FormProyecto : Form
    {
        ...
        */
        ...
        private void MetodoAutomataAnalizador(string cadena)
        {
            ...
            dataErrores.Rows.Clear();    //limpia el dataset
            dataLexemas.Rows.Clear();   //limpia el dataset
        ...
        public void DescripciondelosToken(string tokeniguala)
        {
            switch (tokeniguala)
            {
                ...
                case "class":
                    ...
                    break;
                case "MiClase":
                    txtSalida.Text = txtSalida.Text + "MiClase" + " " + "Nombre Clase\n";
                    break;
                case "{":
        ...
        private void TokenValidos(string lexema)
        {
            ...
            switch (lexema)
            {
                ...
                case "MiClase":
                    dataLexemas.Rows[tokenllevado].Cells["Lexema"].Value = lexema;
                    dataLexemas.Rows[tokenllevado].Cells["Token"].Value = "ID";
                    break;
                case "{":
                    dataLexemas.Rows[tokenllevado].Cells["Lexema"].Value = lexema;
                ...
                case "Int":
                    dataLexemas.Rows[tokenllevado].Cells["Lexema"].Value = lexema;
                    dataLexemas.Rows[tokenllevado].Cells["Token"].Value = "Entero";
                    break;
                case "protected":
                    dataLexemas.Rows[tokenllevado].Cells["Lexema"].Value = lexema;
                    dataLexemas.Rows[tokenllevado].Cells["Token"].Value = "Palabra Reservada";
                ...
                case "String":
                    ...
                    dataLexemas.Rows[tokenllevado].Cells["Token"].Value = "Palabra Reservada";
                    break;
          /*      case  string lex when (Int32.Parse(lexema) < 999):
                    dataLexemas.Rows[tokenllevado].Cells["Lexema"].Value = lexema;
                    dataLexemas.Rows[tokenllevado].Cells["Token"].Value = "Dato numerico";
                    break;
          */
